...
${OBJECTDIR}/Classes/Access_Static_Member/Access_Static_Member.o: Classes/Access_Static_Member/Access_Static_Member.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/Access_Static_Member/Access_Static_Member.o Classes/Access_Static_Member/Access_Static_Member.cpp

${OBJECTDIR}/Classes/Access_Static_Member/Static_Class_member.o: Classes/Access_Static_Member/Static_Class_member.cpp 
	${MKDIR} -p ${OBJECTDIR}/Classes/Access_Static_Member
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/Access_Static_Member/Static_Class_member.o Classes/Access_Static_Member/Static_Class_member.cpp
...
${OBJECTDIR}/Classes/Window_Mgr.o: Classes/Window_Mgr.cpp 
	${MKDIR} -p ${OBJECTDIR}/Classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/Window_Mgr.o Classes/Window_Mgr.cpp
