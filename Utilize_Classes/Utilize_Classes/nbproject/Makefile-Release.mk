...
${OBJECTDIR}/Test_Cases.o: Test_Cases.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Test_Cases.o Test_Cases.cpp

${OBJECTDIR}/classes/Box.o: classes/Box.cpp 
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/Box.o classes/Box.cpp

${OBJECTDIR}/classes/Date.o: classes/Date.cpp 
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/Date.o classes/Date.cpp

${OBJECTDIR}/classes/Test_Box.o: classes/Test_Box.cpp 
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/Test_Box.o classes/Test_Box.cpp

${OBJECTDIR}/classes/Test_Date.o: classes/Test_Date.cpp 
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/Test_Date.o classes/Test_Date.cpp
